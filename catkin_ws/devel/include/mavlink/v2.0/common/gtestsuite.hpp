...
TEST(common, GPS2_RAW)
{
    ...
    packet_in.alt_ellipsoid = 963499284;
    packet_in.h_acc = 963499492;
    packet_in.v_acc = 963499700;
    packet_in.vel_acc = 963499908;
    packet_in.hdg_acc = 963500116;
    packet_in.yaw = 20095;
...
TEST(common_interop, GPS2_RAW)
{
    ...
    mavlink_gps2_raw_t packet_c {
         93372036854775807ULL, 963497880, 963498088, 963498296, 963498504, 18483, 18587, 18691, 18795, 101, 168, 235, 963499284, 963499492, 963499700, 963499908, 963500116, 20095
    };
