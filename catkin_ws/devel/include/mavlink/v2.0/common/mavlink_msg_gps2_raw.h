...
#define MAVLINK_MESSAGE_INFO_GPS2_RAW { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_gps2_raw_t, time_usec) }, \
         ...
         { "alt_ellipsoid", NULL, MAVLINK_TYPE_INT32_T, 0, 35, offsetof(mavlink_gps2_raw_t, alt_ellipsoid) }, \
         { "h_acc", NULL, MAVLINK_TYPE_UINT32_T, 0, 39, offsetof(mavlink_gps2_raw_t, h_acc) }, \
         { "v_acc", NULL, MAVLINK_TYPE_UINT32_T, 0, 43, offsetof(mavlink_gps2_raw_t, v_acc) }, \
         { "vel_acc", NULL, MAVLINK_TYPE_UINT32_T, 0, 47, offsetof(mavlink_gps2_raw_t, vel_acc) }, \
         { "hdg_acc", NULL, MAVLINK_TYPE_UINT32_T, 0, 51, offsetof(mavlink_gps2_raw_t, hdg_acc) }, \
         { "yaw", NULL, MAVLINK_TYPE_UINT16_T, 0, 55, offsetof(mavlink_gps2_raw_t, yaw) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GPS2_RAW { \
...
static inline uint16_t mavlink_msg_gps2_raw_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, uint8_t fix_type, int32_t lat, int32_t lon, int32_t alt, uint16_t eph, uint16_t epv, uint16_t vel, uint16_t cog, uint8_t satellites_visible, uint8_t dgps_numch, uint32_t dgps_age, int32_t alt_ellipsoid, uint32_t h_acc, uint32_t v_acc, uint32_t vel_acc, uint32_t hdg_acc, uint16_t yaw)
{
    ...
    _mav_put_int32_t(buf, 35, alt_ellipsoid);
    _mav_put_uint32_t(buf, 39, h_acc);
    _mav_put_uint32_t(buf, 43, v_acc);
    _mav_put_uint32_t(buf, 47, vel_acc);
    _mav_put_uint32_t(buf, 51, hdg_acc);
    _mav_put_uint16_t(buf, 55, yaw);
...
{
    return _MAV_RETURN_int32_t(msg,  35);
}
...
{
    return _MAV_RETURN_uint32_t(msg,  51);
}
...
{
    return _MAV_RETURN_uint16_t(msg,  55);
}
